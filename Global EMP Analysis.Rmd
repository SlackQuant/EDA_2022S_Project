...
FAA_strategy_ret <- eventReactive(input$go5, {
  ...
  bestN5 <- FAAreturns(adPrices, bestN = 5)
  ...
  all <- cbind(FAA_Opt, bestN5, N6vol1cor1, minRisk, pureMomentum, maxDecor, momDecor)
  colnames(all) <- c("FAA_Opt", "N5", "vol_1_cor_1", "minRisk", "pureMomentum", "maxDecor", "momDecor")
